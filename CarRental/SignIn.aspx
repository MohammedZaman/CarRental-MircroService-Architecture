<%@ Page Language="C#" Inherits="CarRental.SignIn" MasterPageFile="~/SiteMaster.Master" AutoEventWireup="true" %>
        ...
        <h4 class="card-title center-align">Login</h4>
          ...
          <div class="row">
            ...
            <i class="material-icons prefix">email</i>
              <asp:TextBox CssClass="validate" ID="emailTxtBox" runat="server"></asp:TextBox>
               <asp:RequiredFieldValidator ID="RequiredFieldValidatorEmail" runat="server" Style= "width: 128px; color:red;" ErrorMessage="RequiredFieldValidator"
                ControlToValidate="emailTxtBox">* Fill in required Field </asp:RequiredFieldValidator>
          ...
          <div class="row">
            <div class="input-field col s12">
              ...
              <asp:TextBox CssClass="validate" ID="passwordTxtBox" runat="server"></asp:TextBox>
